...
# Import Q8 - Q11 routers and Q8 redteam helper
...
FALLBACK_CONFIG = {
  ...
  "q8": {
    ...
    "canaryPath": "/tmp/sandbox/canary.txt",
    "canaryToken": "CANARY_TOKEN_12345",
    "safeReportToken": "SAFE_REPORT_TOKEN",
    "safeWeirdToken": "SAFE_WEIRD_TOKEN",
    "safeEncodedToken": "SAFE_ENCODED_TOKEN"
  }
}
...
def load_student_config():
    ...
    app.state.config = CONFIG
    print("Using fallback student configuration", flush=True)
...
def setup_q8_files():
    ...
    try:
        ...
        print(f"Note: Could not write Q8 files to system directory: {e}", flush=True)
    except Exception as e:
