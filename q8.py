...
router = APIRouter(tags=["Q8"])

class RedteamRequest(BaseModel):
    tool: str
    arguments: Dict[str, Any]

def parse_possible_ip(host_str: str) -> Optional[Union[ipaddress.IPv4Address, ipaddress.IPv6Address]]:
    if not host_str:
        return None
...
def is_ip_private_or_restricted(ip_obj: Union[ipaddress.IPv4Address, ipaddress.IPv6Address]) -> bool:
    return (
